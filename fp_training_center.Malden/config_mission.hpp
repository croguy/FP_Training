...
*/
#define CFG_ON_LOAD_TITLE "FPArma Training Island" // displayed during mission load. keep it short
#define CFG_ON_LOAD_TEXT "Master the Basics!" // displayed during mission load
#define CFG_LOBBY_TITLE "FPArma Training Island v1" // mission selection screen name. format: <TYPE><SLOTS> - <NAME> <version>
